...
describe("iSAR", () => {
  ...
  it("calculates SAR", () => {
    const res = iSAR(context, "GBPUSD", 15, 0.02, 0.2, 0);
    expect(res).toBeCloseTo(0.9368, 4);
  });
