...
import { iForce } from "../../src/ta/force";
...
describe("iForce", () => {
  ...
  it("calculates force index", () => {
    const res = iForce(context, "GBPUSD", 15, 2, 0, 0, 0);
    expect(res).toBeCloseTo(67.5, 6);
  });
