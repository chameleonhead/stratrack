...
import { iDeMarker } from "../../src/ta/demarker";
...
describe("iDeMarker", () => {
  ...
  it("calculates demarker index", () => {
    const res = iDeMarker(context, "GBPUSD", 15, 3, 0);
    expect(res).toBe(100);
  });
