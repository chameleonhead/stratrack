...
export function createObjects(context: ExecutionContext): Record<string, BuiltinFunction> {
  ...
  return {
    ...
    ObjectGet: (chartId: number = 0, objectName: string, index: number) => {
      ...
      // インデックスに応じて値を返す
      switch (index) {
        case 0: return obj.time1 || 0;
        case 1: return obj.price1 || 0;
        case 2: return obj.time2 || 0;
        case 3: return obj.price2 || 0;
        case 4: return obj.time3 || 0;
        case 5: return obj.price3 || 0;
        default: return 0;
      }
    },

    // オブジェクトの倍精度プロパティ値を取得
    ObjectGetDouble: (chartId: number = 0, objectName: string, propId: number, propModifier: number = 0) => {
      if (!context.terminal) return 0;
      ...
      // プロパティIDに応じて値を返す
      switch (propId) {
        case 0: return obj.price1 || 0;
        case 1: return obj.price2 || 0;
        case 2: return obj.price3 || 0;
        default: return 0;
      }
    },
    ...
    // オブジェクトの整数プロパティ値を取得
    ObjectGetInteger: (chartId: number = 0, objectName: string, propId: number, propModifier: number = 0) => {
      if (!context.terminal) return 0;
      ...
      // プロパティIDに応じて値を返す
      switch (propId) {
        case 0: return obj.type || 0;
        case 1: return obj.subWindow || 0;
        default: return 0;
      }
    },
    ...
    // オブジェクトの文字列プロパティ値を取得
    ObjectGetString: (chartId: number = 0, objectName: string, propId: number, propModifier: number = 0) => {
      if (!context.terminal) return "";
      ...
      switch (propId) {
        ...
        case 1: return obj.properties?.text || "";
        default: return "";
      }
    },

    // 価格値から時間値を取得
    ObjectGetTimeByValue: (chartId: number = 0, objectName: string, value: number, lineId: number = 0) => {
      if (!context.terminal) return 0;
      ...
      // 簡易実装：価格に基づいて時間を計算
      if (obj.price1 !== undefined && obj.price2 !== undefined && obj.time1 !== undefined && obj.time2 !== undefined) {
        const ratio = (value - obj.price1) / (obj.price2 - obj.price1);
    ...
    // 時間値から価格値を取得
    ObjectGetValueByTime: (chartId: number = 0, objectName: string, time: number, lineId: number = 0) => {
      if (!context.terminal) return 0;
    ...
    // オブジェクトの移動
    ObjectMove: (chartId: number = 0, objectName: string, pointIndex: number, time: number, price: number) => {
      if (!context.terminal) return false;
    ...
    ObjectsDeleteAll: (chartId: number = 0, subWindow: number = -1, objectType: number = -1) => {
      ...
      for (const [name, obj] of objects.entries()) {
        if ((subWindow === -1 || obj.subWindow === subWindow) &&
    ...
    ObjectSet: (chartId: number = 0, objectName: string, index: number, value: number) => {
      ...
      // インデックスに応じて値を設定
      switch (index) {
        case 0: obj.time1 = value; break;
        case 1: obj.price1 = value; break;
        case 2: obj.time2 = value; break;
        case 3: obj.price2 = value; break;
        case 4: obj.time3 = value; break;
        case 5: obj.price3 = value; break;
    ...
    // オブジェクトの倍精度プロパティ値を設定
    ObjectSetDouble: (chartId: number = 0, objectName: string, propId: number, value: number, propModifier?: number) => {
      if (!context.terminal) return false;
      ...
      // プロパティIDに応じて値を設定
      switch (propId) {
        case 0: obj.price1 = value; break;
        case 1: obj.price2 = value; break;
        case 2: obj.price3 = value; break;
        default: return false;
      }
    ...
    ObjectSetFiboDescription: (chartId: number = 0, objectName: string, index: number, text: string) => {
      if (!context.terminal) return false;
    ...
    // オブジェクトの整数プロパティ値を設定
    ObjectSetInteger: (chartId: number = 0, objectName: string, propId: number, value: number, propModifier?: number) => {
      if (!context.terminal) return false;
      ...
      // プロパティIDに応じて値を設定
      switch (propId) {
        case 0: obj.type = value; break;
        case 1: obj.subWindow = value; break;
        default: return false;
      }
    ...
    // オブジェクトの文字列プロパティ値を設定
    ObjectSetString: (chartId: number = 0, objectName: string, propId: number, value: string, propModifier?: number) => {
      if (!context.terminal) return false;
      ...
      // プロパティIDに応じて値を設定
      switch (propId) {
        case 0: obj.name = value; break;
        case 1: obj.properties.text = value; break;
        default: return false;
      }
    ...
    // オブジェクトのテキストを設定
    ObjectSetText: (chartId: number = 0, objectName: string, text: string, fontSize: number = 10, fontName: string = "Arial", textColor: number = 0) => {
      if (!context.terminal) return false;
    ...
    // テキストを出力
    TextOut: (text: string, x: number, y: number, anchor: number, data: number[], width: number, height: number, color: number, colorFormat: number) => {
      if (!context.terminal) return false;
